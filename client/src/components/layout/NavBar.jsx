...
function NavBar() {
  ...
  const {CartCount,CartList,CartListRequest}=CartStore()
  ...
  return (
        ...
        <div className="container">
          <div className="row justify-content-around">
            <div className="col-md-6">
              <span>
                <span className="f-12">
                  <i className="bi bi-envelope"></i> Support@ecom.com{" "}
                </span>
                <span className="f-12 mx-2">
                  <i className="bi bi-envelope"></i> 01778429041{" "}
                </span>
              </span>
            </div>
            <div className="col-md-6">
      ...
      <nav className="navbar sticky-top bg-white navbar-expand-lg navbar-light py-3">
        <div className="container">
          <Link className="navbar-brand" to="/">
            ...
            <span className='fw-bold text-success custom-font'>Ecom</span>
          </Link>
          <button
    ...
    nav06"
          ...
          <div className="collapse navbar-collapse" id="nav06">
            <div className="navbar-nav mt-3 mt-lg-0 mb-3 mb-lg-0 ms-lg-3">
    ...
    7 7 0 0114 0z"
            ...
            {isLogin()?(<>
              <Link to="/cart" type="button" className="btn ms-4 btn-light position-relative">
                                ...
                                <Link to="/order" type="button" className="btn ms-4 btn-light position-relative">
            ...
            <UserSubmitButton onClick={logout} text="Logout" className="btn ms-3 btn-success d-flex"/></>):(
               <Link
               type="button"
               className="btn ms-3 btn-success d-flex"
               to="login"
