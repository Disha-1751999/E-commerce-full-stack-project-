                ...
                <div className="container py-4">
                    <div className="row">
                        ...
                        <div className="col-md-5 p-3">
                            ...
                            <p className="text-muted bodySmal my-1">Category: {Details[0]['categories']['categoryName']}</p>
                            <p className="text-muted bodySmal my-1">Brand: {Details[0]['brands']['brandName']}</p>
